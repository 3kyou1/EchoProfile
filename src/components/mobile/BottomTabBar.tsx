import { FolderOpen, MessageSquare, Columns, BarChart3, SlidersHorizontal, Brain, Fingerprint } from "lucide-react";
...
const tabs = [
  ...
  { id: "myTrace", icon: Fingerprint, labelKey: "common.mobile.tab.myTrace", alwaysEnabled: true },

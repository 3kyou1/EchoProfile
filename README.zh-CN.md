...
每天，我们把问题、犹豫、偏好、判断、知识盲区和工作方式交给 AI。

这些对话散落在 Codex、Cursor、Claude Code 和各种本地记录中。它们不是普通聊天记录，而是一条关于你如何思考、学习、决策、协作的长期轨迹。

EchoProfile 会从你的 AI 对话历史中生成个人 AI 画像，并把这份画像变成可以浏览、比较和反思的镜子。
...
抽象的画像很无聊，EchoProfile 引入了 Thought Echoes。
...
同时项目支持导入自制的候选池，我们也提供了制作候选池的skills。
Just for fun！

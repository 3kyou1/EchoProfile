...
fn get_provider_project_token_stats(
    ...
    all_stats.sort_by_key(|stats| std::cmp::Reverse(stats.total_tokens));
    let items = all_stats
        .into_iter()
        .skip(offset)
        .take(limit)
...
fn get_provider_session_comparison(
    ...
    sessions_by_tokens.sort_by_key(|session| std::cmp::Reverse(session.total_tokens));
    ...
    sessions_by_duration.sort_by_key(|session| std::cmp::Reverse(session.duration_seconds));
...
pub async fn get_project_stats_summary(
    ...
    summary
        .most_used_tools
        .sort_by_key(|tool| std::cmp::Reverse(tool.usage_count));
...
pub async fn get_global_stats_summary(
    ...
    summary
        ...
        .sort_by_key(|provider| std::cmp::Reverse(provider.tokens));
    ...
    summary
        .model_distribution
        .sort_by_key(|model| std::cmp::Reverse(model.token_count));
    ...
    summary
        .top_projects
        .sort_by_key(|project| std::cmp::Reverse(project.tokens));
...
mod tests {
    ...
    fn test_calculate_session_active_minutes_handles_long_gaps() {
        ...
        // 10:00-10:20 (20 min) + 14:00-14:30 (30 min) = 50 min
